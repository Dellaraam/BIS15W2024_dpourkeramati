...
) # refers to dropdown menus. x = name of variable (followed by a prompt and its options). Selected = where the option list will start
...
ui <- fluidPage(
    ...
    selectInput("y", "Select Y Variable", choices = c("", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), 
              selected = "bill_length_mm")
)
...
```{r}
# always see what you want the app to do before hand. Here, that means creating the plot you'd like the app to make.
penguins %>% 
