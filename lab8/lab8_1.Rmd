...
penguins %>%
  ...
  summarize(
    ...
    mean_filpper=mean(flipper_length_mm,na.rm=TRUE),
...
penguins %>%
  group_by(species) %>%
  summarize(across(c(bill_length_mm,bill_depth_mm,flipper_length_mm), mean,na.rm=TRUE), n=n()) 
```
```{r}
penguins %>%
  group_by(species) %>%
  summarize(across(c(bill_length_mm,bill_depth_mm,flipper_length_mm),sd,na.rm=TRUE), n=n())
```
